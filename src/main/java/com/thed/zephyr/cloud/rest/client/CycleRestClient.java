...
public interface CycleRestClient {
    ...
    public abstract Cycle cloneCycle(String clonedCycleId, Cycle cycle) throws JSONException, HttpException, BadRequestParamException;
    public abstract <T> T cloneCycle(String clonedCycleId, Cycle cycle, JsonObjectParser<T> parser) throws JSONException, HttpException, BadRequestParamException;
    ...
    InputStream exportCycle(Long projectId, Long versionId, String cycleId, String exportType) throws JobProgressException, HttpException, BadRequestParamException;
    InputStream downloadExportedFile(String fileName) throws JSONException, HttpException, BadRequestParamException;
    JobProgress moveExecutionsToCycle(String cycleId, Long projectId, Long versionId, List<String> executionIds, Boolean clearDefectMappingFlag, Boolean clearStatusFlag) throws JobProgressException, HttpException, BadRequestParamException;
    JobProgress copyExecutionsToCycle(String cycleId, Long projectId, Long versionId, List<String> executionIds, Boolean clearDefectMappingFlag, Boolean clearStatusFlag) throws JobProgressException, HttpException, BadRequestParamException;
}
