...
import com.thed.zephyr.cloud.rest.client.async.AsynchronousZephyrRestClientFactory;
import com.thed.zephyr.cloud.rest.client.model.ZConfig;
 ...
 */
public class ZephyrRestClientUtil {
    ...
    private static ZephyrRestClient createZephyRestClient(final ZConfig zConfig){
    ...
    public static ZephyrRestClient getClient() {
        return client;
    }
}
